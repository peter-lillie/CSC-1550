...
//-----------------------------------------------------
        public void itemStateChanged (ItemEvent event)
        {
            ...
            if (italic.isSelected()) style += Font.ITALIC;
                saying.setFont (new Font ("Helvetica", style, fontSize));
            if(small.isSelected()) {
                saying.setFont(new Font("Helvetica", style, fontSize=12));
            }
            if(medium.isSelected()){
                saying.setFont(new Font("Helvetica", style, fontSize=24));
            }
            if(large.isSelected()) {
                saying.setFont(new Font("Helvetica", style, fontSize=36));
            }
        }
    }
}